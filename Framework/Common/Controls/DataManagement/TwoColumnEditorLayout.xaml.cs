...
namespace TM.Framework.Common.Controls.DataManagement
{
    ...
    public partial class TwoColumnEditorLayout : UserControl
    {
        ...
        public System.Windows.Media.ImageSource? LeftIcon
        {
            get => (System.Windows.Media.ImageSource?)GetValue(LeftIconProperty);
        ...
        public System.Windows.Media.ImageSource? RightIcon
        {
            get => (System.Windows.Media.ImageSource?)GetValue(RightIconProperty);
        ...
        private void UpdateTabHeaders()
        {
            ...
            if (HeaderTabs.Count != requiredCount)
            {
                ...
                HeaderTabs.Add(new TabItemData { Header = Tab1Header ?? "编辑", Icon = null, IsSelected = preservedIndex == 0 });
                HeaderTabs.Add(new TabItemData { Header = Tab2Header ?? "详情", Icon = null, IsSelected = preservedIndex == 1 });

                if (requiredCount >= 3)
                    HeaderTabs.Add(new TabItemData { Header = Tab3Header ?? "Tab3", Icon = null, IsSelected = preservedIndex == 2 });
                if (requiredCount >= 4)
                    HeaderTabs.Add(new TabItemData { Header = Tab4Header ?? "Tab4", Icon = null, IsSelected = preservedIndex == 3 });
                if (requiredCount >= 5)
                    HeaderTabs.Add(new TabItemData { Header = Tab5Header ?? "Tab5", Icon = null, IsSelected = preservedIndex == 4 });
                if (requiredCount >= 6)
                    HeaderTabs.Add(new TabItemData { Header = Tab6Header ?? "Tab6", Icon = null, IsSelected = preservedIndex == 5 });
                if (requiredCount >= 7)
                    HeaderTabs.Add(new TabItemData { Header = Tab7Header ?? "Tab7", Icon = null, IsSelected = preservedIndex == 6 });
                if (requiredCount >= 8)
                    HeaderTabs.Add(new TabItemData { Header = Tab8Header ?? "Tab8", Icon = null, IsSelected = preservedIndex == 7 });

    ...
    public class MonospaceFontDetector
    {
        ...
        public void InitializeDpi()
        {
            try
            {
                ...
                if (mainWindow != null)
                    _pixelsPerDip = VisualTreeHelper.GetDpi(mainWindow).PixelsPerDip;
            }
            catch { }
        }
        ...
        public bool IsMonospace(string fontFamilyName)
        {
            ...
            {
                _cache.TryAdd(fontFamilyName, true);
                return true;
            }

            var result = MeasureCharacterWidths(fontFamilyName);
            _cache.TryAdd(fontFamilyName, result);
            return result;
        }
        ...
        private static bool IsKnownMonospaceFont(string fontName)
        {
            ...
            return _knownMonospaceFonts.Any(mono => lowerName.Contains(mono));
        }

...
namespace TM.Framework.Appearance.Font.Services
{
    ...
    {
        private readonly System.Collections.Concurrent.ConcurrentDictionary<string, Lazy<FontInfoModel>> _cache = new();
        ...
        public FontInfoModel GetFontInfo(string fontName)
        {
            ...
            return _cache.GetOrAdd(fontName,
                key => new Lazy<FontInfoModel>(() => ParseFontInfo(key),
